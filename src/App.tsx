...
function App() {
  ...
  //   });
  // };
        {/* Removed props because the context can directly communicate with NewTodo.tsx and Todos.tsx  -> make sure to wrap this or index.tsx with <TodosContextProvider> tags, he wrapped this 
      instead of just wrapping with divs*/}
